      ...
      <div style={{padding:'8px 14px',background:'#0C100F',borderBottom:'1px solid #120910',display:'flex',alignItems:'center',justifyContent:'space-between',gap:8}}>
        ...
        {isAdmin && (
          <div style={{display:'flex',gap:6}}>
            <button onClick={()=>setAdminTab('programming')} style={{padding:'4px 12px',fontSize:11,fontWeight:600,cursor:'pointer',borderRadius:6,background:adminTab==='programming'?'#BE185D22':'none',border:`1px solid ${adminTab==='programming'?'#BE185D':'#1E3530'}`,color:adminTab==='programming'?'#F9A8D4':'#2A4A44'}}>📅 Programación</button>
            <button onClick={()=>setAdminTab('athletes')} style={{padding:'4px 12px',fontSize:11,fontWeight:600,cursor:'pointer',borderRadius:6,background:adminTab==='athletes'?'#BE185D22':'none',border:`1px solid ${adminTab==='athletes'?'#BE185D':'#1E3530'}`,color:adminTab==='athletes'?'#F9A8D4':'#2A4A44'}}>👥 Atletas</button>
          </div>
        )}
      </div>
