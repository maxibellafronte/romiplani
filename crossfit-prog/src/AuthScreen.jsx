...
const S = {
  input: {
    ...
    background: '#0E1210', border: '1px solid #2A4A44',
    borderRadius: 8, color: '#D4EDE8',
...
export default function AuthScreen() {
    ...
    return (
      <div style={{minHeight:'100vh',background:'#0F1412',display:'flex',alignItems:'center',justifyContent:'center',padding:20}}>
        <div style={{background:'#0E1614',border:'1px solid #2A4A44',borderRadius:14,padding:36,width:'min(420px,100%)',textAlign:'center'}}>
          ...
          <h2 style={{color:'#D4EDE8',fontSize:18,fontWeight:800,marginBottom:12}}>¡Registro exitoso!</h2>
          <p style={{color:'#7AADA0',fontSize:14,lineHeight:1.6,marginBottom:20}}>Tu cuenta fue creada. El coach debe activarla antes de que puedas acceder a la programación.</p>
          <button onClick={()=>{setSuccess(false);setMode('login');setPassword('');}} style={{...S.btnPink,marginTop:0}}>Ir al Login</button>
        </div>
      </div>
    )
  }
  ...
  return (
    <div style={{minHeight:'100vh',background:'#0F1412',display:'flex',alignItems:'center',justifyContent:'center',padding:20}}>
      <div style={{background:'#0E1614',border:'1px solid #2A4A44',borderRadius:14,padding:32,width:'min(420px,100%)'}}>
        <div style={{textAlign:'center',marginBottom:28}}>
          <div style={{fontSize:36,marginBottom:10}}>⚡</div>
          <h1 style={{color:'#D4EDE8',fontSize:20,fontWeight:900,letterSpacing:'0.06em',margin:0}}>CF PROGRAMACIÓN</h1>
          <p style={{color:'#3A6058',fontSize:11,marginTop:6,letterSpacing:'0.1em',textTransform:'uppercase'}}>
        ...
        {error && (
          <div style={{marginTop:12,padding:'10px 13px',background:'#2A1A1A',border:'1px solid #7F3030',borderRadius:8,color:'#FCA5A5',fontSize:13}}>
            {error}
          </div>
        )}
        ...
        <div style={{textAlign:'center',marginTop:20}}>
          {mode === 'login' ? (
            <p style={{color:'#4A7A70',fontSize:13}}>
              ¿No tenés cuenta?{' '}
