  ...
  return (
    <div style={{minHeight:'100vh',background:'#EDF1F5',display:'flex',alignItems:'center',justifyContent:'center',padding:20}}>
      <div style={{background:'#FFFFFF',border:'1px solid #DDE5EC',borderRadius:14,padding:36,width:'min(420px,100%)',textAlign:'center'}}>
        ...
        <div style={{background:'#F7F9FB',border:'1px solid #DDE5EC',borderRadius:8,padding:'12px 16px',marginBottom:24,fontSize:12,color:'#7A8FA0'}}>
          Si ya abonaste y tu cuenta sigue pendiente, contactá al coach directamente.
        </div>
        <button onClick={signOut}
          style={{background:'none',border:'1px solid #C0CDD8',borderRadius:8,color:'#7A8FA0',cursor:'pointer',fontSize:13,padding:'10px 24px'}}>
          Cerrar sesión
        </button>
      </div>
    </div>
